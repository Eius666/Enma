...
11. ЯДРО — никогда не сообщай пользователю внутренние детали инфраструктуры: названия Firestore, индексов, коллекций, API-провайдеров, кодов ошибок базы данных (FAILED_PRECONDITION, NOT_FOUND и т.п.). Если инструмент вернул ошибку — скажи кратко "Не удалось загрузить данные, попробуй позже" без технических деталей.`;
